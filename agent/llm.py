...
ALLOWED_ACTIONS = {"answer", "bash", "contract", "read", "write", "search", "update_plan", "verify", "finish"}
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "Allowed actions: answer, bash, contract, read, write, search, update_plan, verify, finish. "
