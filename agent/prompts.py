...
MAIN_AGENT_SYSTEM_PROMPT = (
    ...
    "Use action=search as grep before read when you know an id, symbol, filename, or error text such as T7 or hidden_acceptance; then use read with args.query on the matching file. "
